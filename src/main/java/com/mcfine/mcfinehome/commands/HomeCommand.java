...
public class HomeCommand implements CommandExecutor {
        ...
        if (sender instanceof Player) {
            ...
            if (args.length == 0) {
                ...
                if (Objects.isNull(homeList) || homeList.size() == 0) {
                    p.sendMessage(ColorTranslator.translateColorCodes("&9Дом &7▪ &cУ вас нет ни одного дома!"));
                    return false;
                }
                int result = Teleporter.tryTpAny(p);
                if (result == -1) {
                    p.sendMessage(ColorTranslator.translateColorCodes("&9Дом &7▪ &cУ вас нет дома с безопасной локацией"));
                } else if (result == 0) {
                    p.sendMessage(ColorTranslator.translateColorCodes("&9Дом &7▪ &cУ вас нет ни одного дома"));
                }
                ...
                if (Objects.isNull(home)) {
                    p.sendMessage(ColorTranslator.translateColorCodes("&9Дом &7▪ &6Нет такого дома"));
                    return false;
                }
                if (home.isPubl() || home.isInvited(p.getName())) {
                    if (Teleporter.tryTp(p, home.getLocation())) {
                        ...
                        p.sendMessage(ColorTranslator.translateColorCodes("&9Дом &7▪ &eВы телепортировались в дом: &6" + home.getHomeName() + " &eигрока: &6" + home.getPlayerName()));
                    }
                } else {
                    p.sendMessage(ColorTranslator.translateColorCodes("&9Дом &7▪ &cВас не пригласил к себе домой &6" + home.getPlayerName()));
                }
                return false;
                ...
                p.sendMessage(ColorTranslator.translateColorCodes("&9Дом &7▪ &cКоманда неизвестна"));
            }
    ...
    public static void setHome(Player p, String[] args) {
        if (args.length == 1) {
            ...
            if (HomeStorage.containsHome(p.getName(), "Main")) {
                ...
                p.sendMessage(ColorTranslator.translateColorCodes("&9Дом &7▪ &6Главный дом перемещен на это место"));
            } else {
                if (HomeStorage.createHome(p, "Main")) {
                    ...
                    if (main != null) {
                        ...
                        p.sendMessage(ColorTranslator.translateColorCodes("&9Дом &7▪ &aТочка главного дома поставлена"));
                    } else {
            ...
            if (HomeStorage.getHomeAmount(p.getName()) < max) {
                ...
                if (HomeStorage.containsHome(p.getName(), args[1].trim())) {
                    ...
                    p.setBedSpawnLocation(home.getLocation());
                    p.sendMessage(ColorTranslator.translateColorCodes("&9Дом &7▪ &aДом успешно перемещен"));
                } else {
                    if (HomeStorage.createHome(p, args[1].trim())) {
                        p.sendMessage(ColorTranslator.translateColorCodes("&9Дом &7▪ &aТочка дома установлена"));
                    } else {
    ...
    public static void renameHome(String playerName, String oldHomeName, String newHomeName) {
        ...
        if (home == null) {
            ...
            player.sendMessage(ColorTranslator.translateColorCodes("&9Дом &7▪ &aДом успешно переименован из &e" + oldHomeName + "&a в &e" + newHomeName));
        }
    }
    ...
    public static void inviteHome(Player p, String[] args) {
        if (args.length == 2) {
            if (args[1].trim().equalsIgnoreCase(p.getName()))
                p.sendMessage(ColorTranslator.translateColorCodes("&9Дом &7▪ &6Это же ваш ник"));
            if (HomeStorage.containsHome(p.getName(), "Main")) {
                Home main = HomeStorage.getHome(p.getName(), "Main");
            ...
            if (HomeStorage.containsHome(p.getName(), args[1].trim())) {
                ...
                if (home.uninvitePlayer(args[2].trim())) {
                    ...
                    if (uninvitedPlayer != null && uninvitedPlayer.getName().equalsIgnoreCase(args[2])) {
                        uninvitedPlayer.sendMessage(ColorTranslator.translateColorCodes("&9Дом &7▪ &6Вы больше не приглашены к &e" + p.getName() + "&6 в дом &e" + home.getHomeName()));
                    }
                } else {
                    p.sendMessage(ColorTranslator.translateColorCodes("&9Дом &7▪ &6Игрок и так не приглашен к вам"));
                }
